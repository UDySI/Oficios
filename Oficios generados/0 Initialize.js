function afterFormSubmit(event) {
  ...
  // La lista producida por insertResponseURLs es para uso exclusivo del administrador
  ...
  insertResponseURLs(form_id, sheet_name_RESPONSE);
  ...
  // Actualizar permisos de acceso a tablero Oficios
  let tablero_id = '1RNqhY8CRYJMM21EPaYm7N1ArxG3o0ht7Mbym4w5Wra8'; // Id del tablero Oficios
  let accessors_sheet_name = 'Accesos';
  let accessors_editors_header = 'Edit (remitentes y redactores)';
  let accessors_viewers_header = 'View (enlaces)';
  updateAccessToResource(tablero_id, 'VIEW', accessors_sheet_name, accessors_viewers_header);
  updateAccessToResource(tablero_id, 'EDIT', accessors_sheet_name, accessors_editors_header);
