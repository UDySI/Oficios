function enviarNotificacion(id_CONSECUTIVO) {
  ...
  emailTemp.file_LINK_OPEN = data[0][headers.indexOf('file_LINK_OPEN')];
  emailTemp.response_FECHA_LARGA = data[0][headers.indexOf('response_FECHA_LARGA')];
  ...
  emailTemp.redactor_INICIALES = data[0][headers.indexOf('redactor_INICIALES')];
  emailTemp.rol_REMITENTE = data[0][headers.indexOf('rol_REMITENTE')];
